...
Convert `usedName`, `stamina` and maps to a character array, to save
memory.

.2017-01-08:

Remove `graphicWindow`.

.2017-01-08:

Convert `possibleNorth` flag and family to calculations.

.2017-01-07:

Rename all words after Forth conventions.
